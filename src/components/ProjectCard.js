  ...
  return (
    <div className="card">
      <div className="img-container">
        <img alt={props.name} src={props.image} width="200" height="250" />
      </div>
      <div className="content">
        ...
        <p>
          <a href={props.github}>
            <svg viewBox="0 0 640 512" width="50" title="laptop-code">
          ...
          <a href={props.deployed}>
            <svg viewBox="0 0 640 512" width="50" title="laptop">
